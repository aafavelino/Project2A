/**
 * \file TriangulationVisitor.h
 *
 * \brief Definition of class TriangulationVisitor, which is a visitor
 * to  collect all  (bounded) triangles,  edges, and  vertices of  the
 * non-trimmed regions of a Constrained Delaunay Triangulation (CDT).
 *
 * \author
...
namespace MAT309
{
	...
	namespace cdt {
		...
		public:
			 ...
			 * \typedef VTAB
			 *
			 * \brief Defines a type for a vertex identifier hash table.
			 */
		...
		public:
			 ...
			 * of all  faces, edges,  and vertices of  the non-trimmed
			 * away regions of a CDT.
			 *
			 ...
			 *
			 * \brief A generic visitor method to visit a quad-edge of
			 * a CDT.
			 *
			 ...
			 *
			 * \brief A generic  visitor method to visit an  edge of a
			 * CDT.
			 *
